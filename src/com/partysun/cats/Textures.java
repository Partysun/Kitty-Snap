...
public class Textures
{
	...
	public static void load(BaseGameActivity activity)
	{
		...
		backTexture = new BuildableTexture(512, 512, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
        ...
        artifactTexture = new BuildableTexture(64, 128, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
